...
namespace VALUES {
	namespace SAFE_VALUES {
		namespace MOVEMENT {
			...
			const float ms_rolling_min = 5.f;
			const float ms_rolling_max = 15.f;
		...
		namespace COLLISIONS {
			const float unintentional_move_speed_min = 0.01f;
			const float unintentional_move_speed_max = 3.f;

			const float unintentional_move_speed_emote_min = 0.01f;
			const float unintentional_move_speed_emote_max = 5.f;
		};
	...
	namespace DEFAULT_VALUES {
		...
		const float default_rollingMaxSpeed = 7.000000f;
		...
		const float default_unintentionalMoveSpeedThreshold = 0.750000f;
		const float default_unintentionalMoveSpeedThresholdDuringEmote = 1.500000f;
		...
		// JUMP
		const float default_landingJumpDelay = 0.05000000075f;
	};
};