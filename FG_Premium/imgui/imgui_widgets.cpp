...
bool ImGui::SliderScalar( const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, float power ) {
	...
	const ImVec2 label_value_size = CalcTextSize( value_buf, NULL, true );
	ImVec2 text_start = ImVec2( frame_bb.Max.x - label_value_size.x - 2, frame_bb.Min.y );

	RenderTextClipped( text_start, frame_bb.Max, value_buf, value_buf_end, NULL, ImVec2( 0.5f, 0.5f ) );
