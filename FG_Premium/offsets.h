...
namespace signatures {
	enum values {
		...
		global_game_state = 48743520, //MPG.Utility.Singleton<GlobalGameStateClient>_TypeInfo
		catapult_services = 48739240, //FGClient.CatapultServices.CatapultServices_TypeInfo
		re_input = 49042856, //Rewired.ReInput_TypeInfo
		cursor_manager = 48819336, //CursorManager_TypeInfo
		get_bound = 32138352, //UnityEngine.Collider$$get_bounds
	};
};
